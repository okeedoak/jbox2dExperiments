...
//    public static final World world = new World(new Vec2(0.0f, -10.0f), true);
    ...
    //DrawLinesDropBalls.Ball radius in pixel
    public static final int BALL_SIZE = 8;

    //Total number of balls
    public final static int NO_OF_BALLS = 400;

    //DrawLinesDropBalls.Ball gradient
    private final static LinearGradient BALL_GRADIENT =
        new LinearGradient(0.0, 0.0, 1.0, 0.0, true,
    ...
    public static LinearGradient getBallGradient(Color color) {
        if (color.equals(Color.RED))
            ...
            return new LinearGradient(0.0, 0.0, 1.0, 0.0, true,
                CycleMethod.NO_CYCLE, new Stop(0, Color.WHITE), new Stop(1, color));
    }
